...
class AggregateMonitorChecks extends Command
{
    ...
    protected function hourlyRollup(): void
    {
        ...
        $buckets = MonitorCheck::query()
            ...
            ->selectRaw('ROUND(AVG(response_time_ms)) as avg_response_time_ms')
            ->selectRaw('MIN(response_time_ms) as min_response_time_ms')
    ...
    protected function dailyRollup(): void
    {
        ...
        $buckets = MonitorCheckAggregate::query()
            ...
            ->selectRaw('ROUND(SUM(avg_response_time_ms * total_checks) / SUM(total_checks)) as avg_response_time_ms')
